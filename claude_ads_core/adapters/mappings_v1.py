...
PROFILES: dict[str, NativeExportProfile] = {
    ...
    "tiktok": NativeExportProfile(
        ...
        "tiktok",
        "disabled",
        "TikTok API for Business integrated AUCTION_AD report CSV projection (regular AUCTION_AD campaigns only; excludes Upgraded Smart+ Ads)",
        ("date", "campaign_id"),
        (
        ...
        ("account_name", "campaign_status", "creative_id", "creative_name", "budget"),
        ("tiktok-integrated-reporting-official",),
        ("https://business-api.tiktok.com/portal/docs?id=1751087777884161",),
        "Official TikTok API documentation does not verify the integrated AUCTION_AD field schema, and ad_id_v2 represents an ad or asset-group ID rather than creative identity; capability is disabled.",
    ),
    "microsoft": NativeExportProfile(
        ...
        (
            ...
            _field("ConversionsQualified", "conversions", "decimal", "ConversionsQualified count for bidding-qualified goals."),
    ...
    "reddit": NativeExportProfile(
        ...
        "reddit",
        "fixture-verified",
        "Reddit Ads API v3 Get A Report JSON response with data.metrics[]",
        ("date", "campaign_id", "creative_id"),
        (
            _field("date", "date", "iso_date", "Report date in UTC."),
            ...
            _field("spend", "spend", "micros", "Reddit spend in microcurrency divided by one million."),
        ...
        ("reddit-ads-reporting-v3-official", "reddit-ads-openapi-v3"),
        ("https://ads-api.reddit.com/docs/v3/api/get-a-report", "https://ads-api.reddit.com/api/v3/openapi.json"),
    ),
